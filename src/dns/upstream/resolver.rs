...
//!
//! 解决循环依赖问题：omnidns 接管 /etc/resolv.conf 后，系统 resolver 指向
//! 127.0.0.1:53（omnidns 自己）。如果上游是 `tls://dns.google`，用系统
//! resolver 解析 dns.google 会查到 omnidns，omnidns 又要查 dns.google，
//! 形成无限循环。
//!
